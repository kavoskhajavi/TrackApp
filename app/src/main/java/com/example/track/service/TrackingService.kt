...
import com.example.track.other.Constants.FASTEST_LOCATION_INTERVAL
import com.example.track.other.Constants.LOCATION_UPDATE_INTERVAL
import com.example.track.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.track.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.track.other.Constants.NOTIFICATION_ID
import com.example.track.other.Constants.TIMER_UPDATE_INTERVAL
...
class TrackingService : LifecycleService() {
   ...
   @Inject
    ...
    @SuppressLint("NotificationPermission", "SuspiciousIndentation")
